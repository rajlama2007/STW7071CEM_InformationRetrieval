...
export default function Home() {
  ...
  return (
    <main
      ...
      <section className='flex flex-col gap-10 p-20 pb-10 place-items-center bg-white px-10 '>
        <Image alt='logo' width={'200'} height={'40'} src={"/logo_cu.png"} priority={true} style={{ width: "auto", height: "auto", maxWidth: "300px" }} />
        <div className='relative w-full flex bg-white container overflow-hidden rounded-md border'>
          ...
          >
            {({ errors, touched }) => (
              <Form className='flex w-full'>
                ...
                <button type='submit' className='h-full py-3 bg-blue-700 px-3 border border-blue-700 rounded-r-md' >
        ...
        (searchResults?.results?.length === undefined)
          ...
          <div className='flex justify-between items-center container mx-auto px-10'>
            <button disabled={pageNumber === 1}
              ...
              }} className={`flex items-center gap-2 px-6 py-2 bg-blue-600 rounded-md text-white ${pageNumber === 1 && "!bg-gray-300"
            ...
            <button
              ...
              onClick={() => {
                setIsLoading(true)
                setPageNumber(pageNumber + 1)
              }} className={`flex items-center gap-2 px-6 py-2 bg-blue-600 rounded-md text-white ${pageNumber === Math.ceil(searchResults?.totalData / pageLimit) && "bg-gray-300"
